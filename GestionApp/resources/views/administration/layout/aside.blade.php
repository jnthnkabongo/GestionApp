...
<body>
    ...
    <!-- ======= Sidebar ======= -->
    <aside id="sidebar" class="bg-white sidebar">
        ...
        <li class="nav-item">
            ...
            <i class="bi bi-menu-button-wide"></i><span>Router</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
        ...
        <li class="nav-item">
            ...
            <i class="bi bi-distribute-horizontal"></i><span>Equipements</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
